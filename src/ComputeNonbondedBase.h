...
SELF(PAIR( foo bar ))
LES(FEP( foo bar ))LES(INT( foo bar ))FEP(INT( foo bar ))LAM(INT( foo bar ))FEP(NOENERGY( foo bar ))ENERGY(
		NOENERGY( foo bar ))TABENERGY(NOTABENERGY( foo bar ))
...
// function body
{
	...
	(
			...
			ENERGY( BigReal vdwEnergy = 0;
					//lyk
					BigReal vdwRepEnergy_11=0.0;
					BigReal vdwRepEnergy_12=0.0;
					BigReal vdwRepEnergy_22=0.0;

					BigReal vdwEnergy_11=0.0;
					BigReal vdwEnergy_12=0.0;
					BigReal vdwEnergy_22=0.0;

					BigReal electEnergy_11=0.0;
					BigReal electEnergy_12=0.0;
					BigReal electEnergy_22=0.0;
					//lyk
	...
	(
			...
			//lyk
			BigReal vdw11_virial_xx = 0;
			BigReal vdw11_virial_xy = 0;
			BigReal vdw11_virial_xz = 0;
			BigReal vdw11_virial_yy = 0;
			BigReal vdw11_virial_yz = 0;
			BigReal vdw11_virial_zz = 0;

			BigReal vdw12_virial_xx = 0;
			BigReal vdw12_virial_xy = 0;
			BigReal vdw12_virial_xz = 0;
			BigReal vdw12_virial_yy = 0;
			BigReal vdw12_virial_yz = 0;
			BigReal vdw12_virial_zz = 0;

			BigReal vdw22_virial_xx = 0;
			BigReal vdw22_virial_xy = 0;
			BigReal vdw22_virial_xz = 0;
			BigReal vdw22_virial_yy = 0;
			BigReal vdw22_virial_yz = 0;
			BigReal vdw22_virial_zz = 0;

			BigReal vdwRep11_virial_xx = 0;
			BigReal vdwRep11_virial_xy = 0;
			BigReal vdwRep11_virial_xz = 0;
			BigReal vdwRep11_virial_yy = 0;
			BigReal vdwRep11_virial_yz = 0;
			BigReal vdwRep11_virial_zz = 0;

			BigReal vdwRep12_virial_xx = 0;
			BigReal vdwRep12_virial_xy = 0;
			BigReal vdwRep12_virial_xz = 0;
			BigReal vdwRep12_virial_yy = 0;
			BigReal vdwRep12_virial_yz = 0;
			BigReal vdwRep12_virial_zz = 0;

			BigReal vdwRep22_virial_xx = 0;
			BigReal vdwRep22_virial_xy = 0;
			BigReal vdwRep22_virial_xz = 0;
			BigReal vdwRep22_virial_yy = 0;
			BigReal vdwRep22_virial_yz = 0;
			BigReal vdwRep22_virial_zz = 0;

			BigReal elect11_virial_xx = 0;
			BigReal elect11_virial_xy = 0;
			BigReal elect11_virial_xz = 0;
			BigReal elect11_virial_yy = 0;
			BigReal elect11_virial_yz = 0;
			BigReal elect11_virial_zz = 0;

			BigReal elect12_virial_xx = 0;
			BigReal elect12_virial_xy = 0;
			BigReal elect12_virial_xz = 0;
			BigReal elect12_virial_yy = 0;
			BigReal elect12_virial_yz = 0;
			BigReal elect12_virial_zz = 0;

			BigReal elect22_virial_xx = 0;
			BigReal elect22_virial_xy = 0;
			BigReal elect22_virial_xz = 0;
			BigReal elect22_virial_yy = 0;
			BigReal elect22_virial_yz = 0;
			BigReal elect22_virial_zz = 0;
			//lyk
	)
	FULL
	(
...
//#endif
	...
	const CompAtomExt *pExt_1 = params->pExt[1];
			//lyk
	register Bool isSelPairs_11=0;
	register Bool isSelPairs_12=0;
	register Bool isSelPairs_22=0;
			//lyk
...
#if ( FAST( 1+ ) 0 )
#if ( PAIR( 1+ ) 0 )
	Force *vdwf11_0 = params->vdwff_11[0];
	Force *vdwf11_1 = params->vdwff_11[1];

	Force *vdwf12_0 = params->vdwff_12[0];
	Force *vdwf12_1 = params->vdwff_12[1];

	Force *vdwf22_0 = params->vdwff_22[0];
	Force *vdwf22_1 = params->vdwff_22[1];

	Force *vdwRepf11_0 = params->vdwRepff_11[0];
	Force *vdwRepf11_1 = params->vdwRepff_11[1];

	Force *vdwRepf12_0 = params->vdwRepff_12[0];
	Force *vdwRepf12_1 = params->vdwRepff_12[1];

	Force *vdwRepf22_0 = params->vdwRepff_22[0];
	Force *vdwRepf22_1 = params->vdwRepff_22[1];
#else
#define vdwf11_1 vdwf11_0
	NBWORKARRAY(Force,vdwf11_0,i_upper);
	memset( (void*) vdwf11_0, 0, i_upper * sizeof(Force) );

#define vdwf12_1 vdwf12_0
	NBWORKARRAY(Force,vdwf12_0,i_upper);
	memset( (void*) vdwf12_0, 0, i_upper * sizeof(Force) );

#define vdwf22_1 vdwf22_0
	NBWORKARRAY(Force,vdwf22_0,i_upper);
	memset( (void*) vdwf22_0, 0, i_upper * sizeof(Force) );

#define vdwRepf11_1 vdwRepf11_0
	NBWORKARRAY(Force,vdwRepf11_0,i_upper);
	memset( (void*) vdwRepf11_0, 0, i_upper * sizeof(Force) );

#define vdwRepf12_1 vdwRepf12_0
	NBWORKARRAY(Force,vdwRepf12_0,i_upper);
	memset( (void*) vdwRepf12_0, 0, i_upper * sizeof(Force) );

#define vdwRepf22_1 vdwRepf22_0
	NBWORKARRAY(Force,vdwRepf22_0,i_upper);
	memset( (void*) vdwRepf22_0, 0, i_upper * sizeof(Force) );
#endif
#endif

#if ( FAST( 1+ ) 0 )
#if ( PAIR( 1+ ) 0 )
	Force *electf11_0 = params->electff_11[0];
	Force *electf11_1 = params->electff_11[1];

	Force *electf12_0 = params->electff_12[0];
	Force *electf12_1 = params->electff_12[1];

	Force *electf22_0 = params->electff_22[0];
	Force *electf22_1 = params->electff_22[1];

#else
#define electf11_1 electf11_0
	NBWORKARRAY(Force,electf11_0,i_upper);
	memset( (void*) electf11_0, 0, i_upper * sizeof(Force) );

#define electf12_1 electf12_0
	NBWORKARRAY(Force,electf12_0,i_upper);
	memset( (void*) electf12_0, 0, i_upper * sizeof(Force) );

#define electf22_1 electf22_0
	NBWORKARRAY(Force,electf22_0,i_upper);
	memset( (void*) electf22_0, 0, i_upper * sizeof(Force) );
#endif
#endif
	//lyk
...
#undef PAIRLISTFROMARRAY
		...
		ACG(
				const BigReal cgkq_i = COULOMB * p_i.cgCharge * cg_dielectric_1;
		)//lyk
...
#define fullf_i_z   vec_extract(fullf_i_v, 2)
		...
		//lyk
		FAST(
				BigReal vdwf11_i_x=0.;
				BigReal vdwf12_i_x=0.;
				BigReal vdwf22_i_x=0.;

				BigReal vdwf11_i_y=0.;
				BigReal vdwf12_i_y=0.;
				BigReal vdwf22_i_y=0.;

				BigReal vdwf11_i_z=0.;
				BigReal vdwf12_i_z=0.;
				BigReal vdwf22_i_z=0.;

				BigReal vdwRepf11_i_x=0.;
				BigReal vdwRepf12_i_x=0.;
				BigReal vdwRepf22_i_x=0.;

				BigReal vdwRepf11_i_y=0.;
				BigReal vdwRepf12_i_y=0.;
				BigReal vdwRepf22_i_y=0.;

				BigReal vdwRepf11_i_z=0.;
				BigReal vdwRepf12_i_z=0.;
				BigReal vdwRepf22_i_z=0.;
		)
		FAST(
				BigReal electf11_i_x=0.;
				BigReal electf12_i_x=0.;
				BigReal electf22_i_x=0.;

				BigReal electf11_i_y=0.;
				BigReal electf12_i_y=0.;
				BigReal electf22_i_y=0.;

				BigReal electf11_i_z=0.;
				BigReal electf12_i_z=0.;
				BigReal electf22_i_z=0.;
		)
		//lyk
...
#define NOT_ALCHPAIR(X) X
		...
		FAST(
				vdwf11_0[i].x += vdwf11_i_x;
				vdwf12_0[i].x += vdwf12_i_x;
				vdwf22_0[i].x += vdwf22_i_x;

				vdwf11_0[i].y += vdwf11_i_y;
				vdwf12_0[i].y += vdwf12_i_y;
				vdwf22_0[i].y += vdwf22_i_y;

				vdwf11_0[i].z += vdwf11_i_z;
				vdwf12_0[i].z += vdwf12_i_z;
				vdwf22_0[i].z += vdwf22_i_z;

				vdwRepf11_0[i].x += vdwRepf11_i_x;
				vdwRepf12_0[i].x += vdwRepf12_i_x;
				vdwRepf22_0[i].x += vdwRepf22_i_x;

				vdwRepf11_0[i].y += vdwRepf11_i_y;
				vdwRepf12_0[i].y += vdwRepf12_i_y;
				vdwRepf22_0[i].y += vdwRepf22_i_y;

				vdwRepf11_0[i].z += vdwRepf11_i_z;
				vdwRepf12_0[i].z += vdwRepf12_i_z;
				vdwRepf22_0[i].z += vdwRepf22_i_z;
		)
		FAST(
				electf11_0[i].x += electf11_i_x;
				electf12_0[i].x += electf12_i_x;
				electf22_0[i].x += electf22_i_x;

				electf11_0[i].y += electf11_i_y;
				electf12_0[i].y += electf12_i_y;
				electf22_0[i].y += electf22_i_y;

				electf11_0[i].z += electf11_i_z;
				electf12_0[i].z += electf12_i_z;
				electf22_0[i].z += electf22_i_z;
		)
		//lyk
#endif
		PAIR(
...
#if ( SELF( 1+ ) 0 )
	{
		Force *patch_vdwf11_0 = params->vdwff_11[0];
		Force *patch_vdwf12_0 = params->vdwff_12[0];
		Force *patch_vdwf22_0 = params->vdwff_22[0];

		Force *patch_vdwRepf11_0 = params->vdwRepff_11[0];
		Force *patch_vdwRepf12_0 = params->vdwRepff_12[0];
		Force *patch_vdwRepf22_0 = params->vdwRepff_22[0];

		Force *patch_electf11_0 = params->electff_11[0];
		Force *patch_electf12_0 = params->electff_12[0];
		Force *patch_electf22_0 = params->electff_22[0];
...
#pragma ivdep
		...
		for (int i = 0; i< i_upper; ++i) {
			patch_vdwf11_0[i].x += vdwf11_0[i].x;
			patch_vdwf11_0[i].y += vdwf11_0[i].y;
			patch_vdwf11_0[i].z += vdwf11_0[i].z;

			patch_vdwf12_0[i].x += vdwf12_0[i].x;
			patch_vdwf12_0[i].y += vdwf12_0[i].y;
			patch_vdwf12_0[i].z += vdwf12_0[i].z;

			patch_vdwf22_0[i].x += vdwf22_0[i].x;
			patch_vdwf22_0[i].y += vdwf22_0[i].y;
			patch_vdwf22_0[i].z += vdwf22_0[i].z;

			patch_vdwRepf11_0[i].x += vdwRepf11_0[i].x;
			patch_vdwRepf11_0[i].y += vdwRepf11_0[i].y;
			patch_vdwRepf11_0[i].z += vdwRepf11_0[i].z;

			patch_vdwRepf12_0[i].x += vdwRepf12_0[i].x;
			patch_vdwRepf12_0[i].y += vdwRepf12_0[i].y;
			patch_vdwRepf12_0[i].z += vdwRepf12_0[i].z;

			patch_vdwRepf22_0[i].x += vdwRepf22_0[i].x;
			patch_vdwRepf22_0[i].y += vdwRepf22_0[i].y;
			patch_vdwRepf22_0[i].z += vdwRepf22_0[i].z;

			vdw11_virial_xx += vdwf11_0[i].x * p_0[i].position.x;
			vdw11_virial_xy += vdwf11_0[i].x * p_0[i].position.y;
			vdw11_virial_xz += vdwf11_0[i].x * p_0[i].position.z;
			vdw11_virial_yy += vdwf11_0[i].y * p_0[i].position.y;
			vdw11_virial_yz += vdwf11_0[i].y * p_0[i].position.z;
			vdw11_virial_zz += vdwf11_0[i].z * p_0[i].position.z;

			vdw12_virial_xx += vdwf12_0[i].x * p_0[i].position.x;
			vdw12_virial_xy += vdwf12_0[i].x * p_0[i].position.y;
			vdw12_virial_xz += vdwf12_0[i].x * p_0[i].position.z;
			vdw12_virial_yy += vdwf12_0[i].y * p_0[i].position.y;
			vdw12_virial_yz += vdwf12_0[i].y * p_0[i].position.z;
			vdw12_virial_zz += vdwf12_0[i].z * p_0[i].position.z;

			vdw22_virial_xx += vdwf22_0[i].x * p_0[i].position.x;
			vdw22_virial_xy += vdwf22_0[i].x * p_0[i].position.y;
			vdw22_virial_xz += vdwf22_0[i].x * p_0[i].position.z;
			vdw22_virial_yy += vdwf22_0[i].y * p_0[i].position.y;
			vdw22_virial_yz += vdwf22_0[i].y * p_0[i].position.z;
			vdw22_virial_zz += vdwf22_0[i].z * p_0[i].position.z;

			vdwRep11_virial_xx += vdwRepf11_0[i].x * p_0[i].position.x;
			vdwRep11_virial_xy += vdwRepf11_0[i].x * p_0[i].position.y;
			vdwRep11_virial_xz += vdwRepf11_0[i].x * p_0[i].position.z;
			vdwRep11_virial_yy += vdwRepf11_0[i].y * p_0[i].position.y;
			vdwRep11_virial_yz += vdwRepf11_0[i].y * p_0[i].position.z;
			vdwRep11_virial_zz += vdwRepf11_0[i].z * p_0[i].position.z;

			vdwRep12_virial_xx += vdwRepf12_0[i].x * p_0[i].position.x;
			vdwRep12_virial_xy += vdwRepf12_0[i].x * p_0[i].position.y;
			vdwRep12_virial_xz += vdwRepf12_0[i].x * p_0[i].position.z;
			vdwRep12_virial_yy += vdwRepf12_0[i].y * p_0[i].position.y;
			vdwRep12_virial_yz += vdwRepf12_0[i].y * p_0[i].position.z;
			vdwRep12_virial_zz += vdwRepf12_0[i].z * p_0[i].position.z;

			vdwRep22_virial_xx += vdwRepf22_0[i].x * p_0[i].position.x;
			vdwRep22_virial_xy += vdwRepf22_0[i].x * p_0[i].position.y;
			vdwRep22_virial_xz += vdwRepf22_0[i].x * p_0[i].position.z;
			vdwRep22_virial_yy += vdwRepf22_0[i].y * p_0[i].position.y;
			vdwRep22_virial_yz += vdwRepf22_0[i].y * p_0[i].position.z;
			vdwRep22_virial_zz += vdwRepf22_0[i].z * p_0[i].position.z;
		}

		for (int i = 0; i< i_upper; ++i) {
			patch_electf11_0[i].x += electf11_0[i].x;
			patch_electf11_0[i].y += electf11_0[i].y;
			patch_electf11_0[i].z += electf11_0[i].z;

			patch_electf12_0[i].x += electf12_0[i].x;
			patch_electf12_0[i].y += electf12_0[i].y;
			patch_electf12_0[i].z += electf12_0[i].z;

			patch_electf22_0[i].x += electf22_0[i].x;
			patch_electf22_0[i].y += electf22_0[i].y;
			patch_electf22_0[i].z += electf22_0[i].z;

			elect11_virial_xx += electf11_0[i].x * p_0[i].position.x;
			elect11_virial_xy += electf11_0[i].x * p_0[i].position.y;
			elect11_virial_xz += electf11_0[i].x * p_0[i].position.z;
			elect11_virial_yy += electf11_0[i].y * p_0[i].position.y;
			elect11_virial_yz += electf11_0[i].y * p_0[i].position.z;
			elect11_virial_zz += electf11_0[i].z * p_0[i].position.z;

			elect12_virial_xx += electf12_0[i].x * p_0[i].position.x;
			elect12_virial_xy += electf12_0[i].x * p_0[i].position.y;
			elect12_virial_xz += electf12_0[i].x * p_0[i].position.z;
			elect12_virial_yy += electf12_0[i].y * p_0[i].position.y;
			elect12_virial_yz += electf12_0[i].y * p_0[i].position.z;
			elect12_virial_zz += electf12_0[i].z * p_0[i].position.z;

			elect22_virial_xx += electf22_0[i].x * p_0[i].position.x;
			elect22_virial_xy += electf22_0[i].x * p_0[i].position.y;
			elect22_virial_xz += electf22_0[i].x * p_0[i].position.z;
			elect22_virial_yy += electf22_0[i].y * p_0[i].position.y;
			elect22_virial_yz += electf22_0[i].y * p_0[i].position.z;
			elect22_virial_zz += electf22_0[i].z * p_0[i].position.z;
		}
...
#pragma ivdep
	...
	(
			...
			ENERGY( reduction[vdwEnergyIndex] += vdwEnergy;
					//lyk
					reduction[vdwRepEnergyIndex_11] += vdwRepEnergy_11;
					reduction[vdwRepEnergyIndex_12] += vdwRepEnergy_12;
					reduction[vdwRepEnergyIndex_22] += vdwRepEnergy_22;

					reduction[vdwEnergyIndex_11] += vdwEnergy_11;
					reduction[vdwEnergyIndex_12] += vdwEnergy_12;
					reduction[vdwEnergyIndex_22] += vdwEnergy_22;

					reduction[electEnergyIndex_11] += electEnergy_11;
					reduction[electEnergyIndex_12] += electEnergy_12;
					reduction[electEnergyIndex_22] += electEnergy_22;
					//lyk
			...
			//lyk
			reduction[vdwVirialIndex_11_XX] += vdw11_virial_xx;
			reduction[vdwVirialIndex_11_XY] += vdw11_virial_xy;
			reduction[vdwVirialIndex_11_XZ] += vdw11_virial_xz;
			reduction[vdwVirialIndex_11_YX] += vdw11_virial_xy;
			reduction[vdwVirialIndex_11_YY] += vdw11_virial_yy;
			reduction[vdwVirialIndex_11_YZ] += vdw11_virial_yz;
			reduction[vdwVirialIndex_11_ZX] += vdw11_virial_xz;
			reduction[vdwVirialIndex_11_ZY] += vdw11_virial_yz;
			reduction[vdwVirialIndex_11_ZZ] += vdw11_virial_zz;

			reduction[vdwVirialIndex_12_XX] += vdw12_virial_xx;
			reduction[vdwVirialIndex_12_XY] += vdw12_virial_xy;
			reduction[vdwVirialIndex_12_XZ] += vdw12_virial_xz;
			reduction[vdwVirialIndex_12_YX] += vdw12_virial_xy;
			reduction[vdwVirialIndex_12_YY] += vdw12_virial_yy;
			reduction[vdwVirialIndex_12_YZ] += vdw12_virial_yz;
			reduction[vdwVirialIndex_12_ZX] += vdw12_virial_xz;
			reduction[vdwVirialIndex_12_ZY] += vdw12_virial_yz;
			reduction[vdwVirialIndex_12_ZZ] += vdw12_virial_zz;

			reduction[vdwVirialIndex_22_XX] += vdw22_virial_xx;
			reduction[vdwVirialIndex_22_XY] += vdw22_virial_xy;
			reduction[vdwVirialIndex_22_XZ] += vdw22_virial_xz;
			reduction[vdwVirialIndex_22_YX] += vdw22_virial_xy;
			reduction[vdwVirialIndex_22_YY] += vdw22_virial_yy;
			reduction[vdwVirialIndex_22_YZ] += vdw22_virial_yz;
			reduction[vdwVirialIndex_22_ZX] += vdw22_virial_xz;
			reduction[vdwVirialIndex_22_ZY] += vdw22_virial_yz;
			reduction[vdwVirialIndex_22_ZZ] += vdw22_virial_zz;

			reduction[vdwRepVirialIndex_11_XX] += vdwRep11_virial_xx;
			reduction[vdwRepVirialIndex_11_XY] += vdwRep11_virial_xy;
			reduction[vdwRepVirialIndex_11_XZ] += vdwRep11_virial_xz;
			reduction[vdwRepVirialIndex_11_YX] += vdwRep11_virial_xy;
			reduction[vdwRepVirialIndex_11_YY] += vdwRep11_virial_yy;
			reduction[vdwRepVirialIndex_11_YZ] += vdwRep11_virial_yz;
			reduction[vdwRepVirialIndex_11_ZX] += vdwRep11_virial_xz;
			reduction[vdwRepVirialIndex_11_ZY] += vdwRep11_virial_yz;
			reduction[vdwRepVirialIndex_11_ZZ] += vdwRep11_virial_zz;

			reduction[vdwRepVirialIndex_12_XX] += vdwRep12_virial_xx;
			reduction[vdwRepVirialIndex_12_XY] += vdwRep12_virial_xy;
			reduction[vdwRepVirialIndex_12_XZ] += vdwRep12_virial_xz;
			reduction[vdwRepVirialIndex_12_YX] += vdwRep12_virial_xy;
			reduction[vdwRepVirialIndex_12_YY] += vdwRep12_virial_yy;
			reduction[vdwRepVirialIndex_12_YZ] += vdwRep12_virial_yz;
			reduction[vdwRepVirialIndex_12_ZX] += vdwRep12_virial_xz;
			reduction[vdwRepVirialIndex_12_ZY] += vdwRep12_virial_yz;
			reduction[vdwRepVirialIndex_12_ZZ] += vdwRep12_virial_zz;

			reduction[vdwRepVirialIndex_22_XX] += vdwRep22_virial_xx;
			reduction[vdwRepVirialIndex_22_XY] += vdwRep22_virial_xy;
			reduction[vdwRepVirialIndex_22_XZ] += vdwRep22_virial_xz;
			reduction[vdwRepVirialIndex_22_YX] += vdwRep22_virial_xy;
			reduction[vdwRepVirialIndex_22_YY] += vdwRep22_virial_yy;
			reduction[vdwRepVirialIndex_22_YZ] += vdwRep22_virial_yz;
			reduction[vdwRepVirialIndex_22_ZX] += vdwRep22_virial_xz;
			reduction[vdwRepVirialIndex_22_ZY] += vdwRep22_virial_yz;
			reduction[vdwRepVirialIndex_22_ZZ] += vdwRep22_virial_zz;

			reduction[electVirialIndex_11_XX] += elect11_virial_xx;
			reduction[electVirialIndex_11_XY] += elect11_virial_xy;
			reduction[electVirialIndex_11_XZ] += elect11_virial_xz;
			reduction[electVirialIndex_11_YX] += elect11_virial_xy;
			reduction[electVirialIndex_11_YY] += elect11_virial_yy;
			reduction[electVirialIndex_11_YZ] += elect11_virial_yz;
			reduction[electVirialIndex_11_ZX] += elect11_virial_xz;
			reduction[electVirialIndex_11_ZY] += elect11_virial_yz;
			reduction[electVirialIndex_11_ZZ] += elect11_virial_zz;

			reduction[electVirialIndex_12_XX] += elect12_virial_xx;
			reduction[electVirialIndex_12_XY] += elect12_virial_xy;
			reduction[electVirialIndex_12_XZ] += elect12_virial_xz;
			reduction[electVirialIndex_12_YX] += elect12_virial_xy;
			reduction[electVirialIndex_12_YY] += elect12_virial_yy;
			reduction[electVirialIndex_12_YZ] += elect12_virial_yz;
			reduction[electVirialIndex_12_ZX] += elect12_virial_xz;
			reduction[electVirialIndex_12_ZY] += elect12_virial_yz;
			reduction[electVirialIndex_12_ZZ] += elect12_virial_zz;

			reduction[electVirialIndex_22_XX] += elect22_virial_xx;
			reduction[electVirialIndex_22_XY] += elect22_virial_xy;
			reduction[electVirialIndex_22_XZ] += elect22_virial_xz;
			reduction[electVirialIndex_22_YX] += elect22_virial_xy;
			reduction[electVirialIndex_22_YY] += elect22_virial_yy;
			reduction[electVirialIndex_22_YZ] += elect22_virial_yz;
			reduction[electVirialIndex_22_ZX] += elect22_virial_xz;
			reduction[electVirialIndex_22_ZY] += elect22_virial_yz;
			reduction[electVirialIndex_22_ZZ] += elect22_virial_zz;
			//lyk
	)
	FULL
	(
