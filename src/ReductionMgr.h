...
typedef enum {
	...
	REDUCTION_11_LJ_ENERGY,
	REDUCTION_11_REPLJ_ENERGY,
	REDUCTION_11_ELECT_ENERGY,

	REDUCTION_12_LJ_ENERGY,
	REDUCTION_12_REPLJ_ENERGY,
	REDUCTION_12_ELECT_ENERGY,

	REDUCTION_22_LJ_ENERGY,
	REDUCTION_22_REPLJ_ENERGY,
	REDUCTION_22_ELECT_ENERGY,

	TENSOR(REDUCTION_VIRIAL_11_VDW),
	TENSOR(REDUCTION_VIRIAL_12_VDW),
	TENSOR(REDUCTION_VIRIAL_22_VDW),

	TENSOR(REDUCTION_VIRIAL_11_REPVDW),
	TENSOR(REDUCTION_VIRIAL_12_REPVDW),
	TENSOR(REDUCTION_VIRIAL_22_REPVDW),

	TENSOR(REDUCTION_VIRIAL_11_ELECT),
	TENSOR(REDUCTION_VIRIAL_12_ELECT),
	TENSOR(REDUCTION_VIRIAL_22_ELECT),
	//lyk
	...
	// Ported by JLai from NAMD-Go 2.7
	// JLai
...
public:
	...
	void buildSpanTree(const int pe, const int max_intranode_children, const int max_internode_children, int* parent,
