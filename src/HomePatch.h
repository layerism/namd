...
private:
	...
	BigReal settle_mOrmT;
	BigReal settle_mHrmT;
	BigReal settle_ra;
	BigReal settle_rb;
	BigReal settle_rc;
	BigReal settle_rra;
	...
	void reposition_lonepair(Vector& ri , const Vector& rj , const Vector& rk , const Vector& rl ,
	...
	void redistrib_lp_force(Vector& fi , Vector& fj , Vector& fk , Vector& fl , const Vector& ri ,
			const Vector& rj , const Vector& rk , const Vector& rl , Tensor *virial , int midpt);

	// use for both TIP4P and SWM4 water
	void redistrib_lp_water_force(Vector& f_ox , Vector& f_h1 , Vector& f_h2 , Vector& f_lp ,
			const Vector& p_ox , const Vector& p_h1 , const Vector& p_h2 , const Vector& p_lp ,
			Tensor *virial);
