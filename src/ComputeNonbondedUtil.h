...
class Pairlists {
	...
	Pairlists& operator=(const Pairlists&) {
		return *this;
	}
public:
	Pairlists() :
			size(initsize) {
		data = new plint[initsize];
	}
	~Pairlists() {
		delete[] data;
	}
...
public:
	...
	//lyk
	ResizeArray<Force> vdwf11_0;
	ResizeArray<Force> vdwf12_0;
	ResizeArray<Force> vdwf22_0;
	ResizeArray<Force> vdwRepf11_0;
	ResizeArray<Force> vdwRepf12_0;
	ResizeArray<Force> vdwRepf22_0;

	ResizeArray<Force> electf11_0;
	ResizeArray<Force> electf12_0;
	ResizeArray<Force> electf22_0;
	//lyk
};
...
public:
	...
	enum {
		exclChecksumIndex, pairlistWarningIndex, electEnergyIndex, fullElectEnergyIndex, vdwEnergyIndex,
		//lyk		
		vdwRepEnergyIndex_11,
		vdwRepEnergyIndex_12,
		vdwRepEnergyIndex_22,
		...
		TENSOR(vdwVirialIndex_11),
		TENSOR(vdwVirialIndex_12),
		TENSOR(vdwVirialIndex_22),

		TENSOR(vdwRepVirialIndex_11),
		TENSOR(vdwRepVirialIndex_12),
		TENSOR(vdwRepVirialIndex_22),

		TENSOR(electVirialIndex_11),
		TENSOR(electVirialIndex_12),
		TENSOR(electVirialIndex_22),
		//lyk
		goNativeEnergyIndex,
...
//sd-de
		TENSOR(virialIndex),
		TENSOR(fullElectVirialIndex),
		VECTOR(pairVDWForceIndex),
		VECTOR(pairElectForceIndex),
		reductionDataSize
	};
...
//lyk
	...
	static Bool adaptCgOn;
	static int cgGroup;
	static int aaGroup;
	static BigReal cg_dielectric_1;
	static BigReal cgVdwCappedN;
	static BigReal cgVdwCappedSwitchF;
	static BigReal cgScaling;
//lyk
...
// for simplifying some common functions
	inline static BigReal square(const BigReal &x, const BigReal &y, const BigReal &z) {
		return (x * x + y * y + z * z);
	}
...
//ITS sampling
	static void calc_pair_its(nonbonded *);
	static void calc_pair_energy_its(nonbonded *);
	static void calc_pair_fullelect_its(nonbonded *);
	static void calc_pair_energy_fullelect_its(nonbonded *);
	static void calc_pair_merge_fullelect_its(nonbonded *);
	static void calc_pair_energy_merge_fullelect_its(nonbonded *);
	static void calc_pair_slow_fullelect_its(nonbonded *);
	static void calc_pair_energy_slow_fullelect_its(nonbonded *);
	static void calc_self_its(nonbonded *);
	static void calc_self_energy_its(nonbonded *);
	static void calc_self_fullelect_its(nonbonded *);
	static void calc_self_energy_fullelect_its(nonbonded *);
	static void calc_self_merge_fullelect_its(nonbonded *);
	static void calc_self_energy_merge_fullelect_its(nonbonded *);
	static void calc_self_slow_fullelect_its(nonbonded *);
	static void calc_self_energy_slow_fullelect_its(nonbonded *);

//ACG method
	static void calc_pair_acg(nonbonded *);
	static void calc_pair_energy_acg(nonbonded *);
	static void calc_pair_fullelect_acg(nonbonded *);
	static void calc_pair_energy_fullelect_acg(nonbonded *);
	static void calc_pair_merge_fullelect_acg(nonbonded *);
	static void calc_pair_energy_merge_fullelect_acg(nonbonded *);
	static void calc_pair_slow_fullelect_acg(nonbonded *);
	static void calc_pair_energy_slow_fullelect_acg(nonbonded *);
	static void calc_self_acg(nonbonded *);
	static void calc_self_energy_acg(nonbonded *);
	static void calc_self_fullelect_acg(nonbonded *);
	static void calc_self_energy_fullelect_acg(nonbonded *);
	static void calc_self_merge_fullelect_acg(nonbonded *);
	static void calc_self_energy_merge_fullelect_acg(nonbonded *);
	static void calc_self_slow_fullelect_acg(nonbonded *);
	static void calc_self_energy_slow_fullelect_acg(nonbonded *);
