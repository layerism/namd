...
private:
	...
	struct bond_params *add_to_bond_tree(struct bond_params *, struct bond_params *);

	void add_angle_param(char *);		//  Add an angle parameter
	struct angle_params *add_to_angle_tree(struct angle_params *, struct angle_params *);
	...
	struct vdw_params *add_to_vdw_tree(struct vdw_params *, struct vdw_params *);
	...
	int vdw_pair_to_arrays(int *, int *, Real *, Real *, Real *, Real *, int, IndexedVdwPair *);
...
public:
	...
	//  to an improper
	void assign_crossterm_index(char *, char*, char*, char *, char *, char*, char*, char *,
			Crossterm *);
