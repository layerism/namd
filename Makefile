...
OBJS = \
	...
	$(DSTDIR)/ComputeNonbondedACG.o \
	$(DSTDIR)/ComputeNonbondedITS.o \
...
depends: $(MKINCDIR) $(CIFILES) $(MKDSTDIR) $(DEPENDFILE)
	...
	sed -e "/obj\/Controller.o/ s/CXXFLAGS/CXXTHREADFLAGS/" \
	    ...
	    -e "/obj\/ComputeNonbondedLES.o/ s/CXXFLAGS/CXXNOALIASFLAGS/" \
			-e "/obj\/ComputeNonbondedACG.o/ s/CXXFLAGS/CXXNOALIASFLAGS/" \
			-e "/obj\/ComputeNonbondedITS.o/ s/CXXFLAGS/CXXNOALIASFLAGS/" \
